            ...
            <div className="container mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-gray-700 p-6 rounded-md">
                        ...
                        <a href="https://www.fleco.cloud/" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">View Website</a>
                    </div>
                    ...
                    <div className="bg-gray-700 p-6 rounded-md">
                        ...
                        <a href="https://github.com/HussGB/ferolix" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">View Github</a>
                    </div>
                    ...
                    <div className="bg-gray-700 p-6 rounded-md">
                        ...
                        <a href="https://github.com/HussGB/idle-bee-farm-v1" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">View GitHub</a>
                    </div>
                    ...
                    <div className="bg-gray-700 p-6 rounded-md">
                        ...
                        <a href="https://github.com/IdleDevelopment" target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">View GitHub</a>
                    </div>
                </div>
            </div>
