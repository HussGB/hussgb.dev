      ...
      <div className="container mx-auto text-center">
        ...
        <div className="mt-8 flex justify-center">
          <ul className="flex space-x-4">
            ...
            <li>
              <a href="https://github.com/hussgb" target="_blank" rel="noreferrer" className="text-white">
                <FontAwesomeIcon icon={faGithub} size="2x" />
              </a>
            </li>
            <li>
              <a href="https://discord.com/users/532349905679679498" target="_blank" rel="noreferrer" className="text-white">
